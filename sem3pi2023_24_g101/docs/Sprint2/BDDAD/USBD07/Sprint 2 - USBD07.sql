--US07:
--Como gestor agricula pretendo saber o numero de operaçoes realizado em uma dada parcela para cada para cada tipo de operação, num dado intervalo de tempo.
