    ...
    begin
        open operacoesParcela for
            ...
            select colheita.data, 'Colheita' as OPERACAO, colheita.designacaoparcela, colheita.quantidadekg, 'kg' as unidade, null as DURACAOMIN
            from colheita
            ...
            select monda.data, 'Monda' as OPERACAO, monda.designacaoparcela, monda.quantidadeha, 'kg' as unidade, null as DURACAOMIN
            from monda
